    ...
    <>
      ...
      {error && <p>{error} </p>}
        <form className="App" onSubmit={handleSubmit}>
          ...
          <p>Email: <input id="mail" type="email" placeholder="Email that you use" onChange={handleChange}></input></p>
          <p>Password: <input id="pass" type="password" placeholder="Password " onChange={handleChange}></input></p>
